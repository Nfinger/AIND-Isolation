        ...
        **********************************************************************
        ...
        def min_value(self, game, depth):
            ...
            for move in game.get_legal_moves():
                temp = min(v, max_value(self, game.forecast_move(move), depth-1)[0])
                if temp < v:
                    v = temp
                    best_move = move
            return v, best_move
        ...
        def max_value(self, game, depth):
            ...
            v = float("-inf")
            for move in game.get_legal_moves():
                temp = max(v, min_value(self, game.forecast_move(move), depth-1)[0])
                if temp > v:
                    v = temp
                    best_move = move
            return v, best_move
        ...
        if self.time_left() < self.TIMER_THRESHOLD:
            raise SearchTimeout()
        v, move = min_value(self, game, depth-1)
        return move
